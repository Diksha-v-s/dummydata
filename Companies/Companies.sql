...
SET a=1;
        Label1: WHILE a<=50 DO
          insert into Companies ( `CompanyName`,`RepName`,`RepEmail`,`RepPhone`,`Comments`,`UserKey_LastUpdatedBy`, `UserKey_CreatedBy`,`CompanyCreateTS`,`CompanyLastUpdatedDateTime`) values
          ...
          concat(char(round(rand()*25)+65),char(round(rand()*25)+65),char(round(rand()*25)+65),char(round(rand()*25)+65),char(round(rand()*25)+65),char(round(rand()*25)+65),char(round(rand()*25)+65),
